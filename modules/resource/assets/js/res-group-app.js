...
app.factory("Resource", function ($http) {
    ...
    /*var resources = [];
    $http.get('/resource/res-users/resource-for-form-ajax')
...
app.controller("ResGroupFormController", function ($scope, $http,
    ...
    console.log("initial");
    var params = {};
    $http.get('index.php?r=resource/res-users/user-list-json',{params:params})
            .then(function (response) {
    ...
    $http.get('index.php?r=resource/res-group/list-group-users&group_id=' + $scope.group_id)
            .then(function (response) {
                var resources = response.data;
                console.log(resources);
    ...
    $scope.addUserToGroup = function(){
        ...
        $http.post('index.php?r=resource/res-group/add-group-user',params)
            .then(function (response) {
    ...
    $scope.deleteGroupUser = function(user){
        var uid = user.id;
        var params = {group_id:$scope.group_id,user_id:uid};
        $http.post('index.php?r=resource/res-group/delete-group-user',params)
            .then(function (response) {
                var resources = response.data;
                console.log(resources);
