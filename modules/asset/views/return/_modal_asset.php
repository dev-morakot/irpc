  ...
  <div class="modal-dialog" role="document" style="width: 70%">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <h4><b class="glyphicon glyphicon-plus"></b> ใบคืนพัสดุ - ครุภัณฑ์ </h4>
           ...
           <table class="table table-bordred table-striped" style="margin-top: 15px">
                ...
                <tbody>
                    <tr ng-repeat="line in return_cart track by $index">
                       ...
                       <td align="center">
                            <button class="btn btn-danger btn-sm" ng-click="removeItem(line)"> <b class="glyphicon glyphicon-remove"></b> </button>
                       </td>
                    </tr>
                </tbody>
                <tfoot>
