...
use yii\web\View;
use yii\helpers\Url;
use app\modules\asset\assets\ReturnOrderAsset;


/* @var $this yii\web\View */
/* @var $model app\modules\resource\models\ResUsers */

$this->title = Yii::t('app', 'ใบคืนพัสดุ-ครุภัณฑ์');
$this->params['breadcrumbs'][] = ['label' => 'ใบคืนพัสดุ-ครุภัณฑ์', 'url' => ['add']];
...
$this->registerCss('
            ...
            ');
ReturnOrderAsset::register($this);
?>
<div ng-app="myApp" ng-controller="ReturnController" class="return-index" ng-cloak>

    <h1><?= Html::encode($this->title) ?></h1>

    <button class="btn btn-success">
        ใบคืนพัสดุ-ครุภัณฑ์ <span class="badge">{{ return_cart.length }}</span>
    </button>
    <div class="table-responsive">
        <table class="table table-striped table-bordered" style="margin-top: 15px">
            ...
            <tbody>
                <tr ng-repeat="line in listReturn | filter: search">
                    <td>{{ $index + 1 }}</td>
                    <td>{{ line.name }}</td>
                    ...
                    <td align="center">
                        <button class="btn btn-primary" ng-click="addData(line)" data-toggle="modal" data-target="#myModal"> คืนพัสดุ </button>
                    </td>
                </tr>
            </tbody>
        </table>
