...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'ตรวจสอบใบคืน'), 'url' => ['index']];
...
<div class="view">
    ...
    <p class="pull-left">
        <?php if($model->state == ReturnOrder::WAIT) {
    ...
    <p class="pull-right">
        ...
        ?>
        <?php endif; ?>
        <?php if($model->state == ReturnOrder::APPROVED): ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
        <h4>รายการใบคืนพัสดุ-ครุภัณฑ์:</h4>
                <?= GridView::widget([
