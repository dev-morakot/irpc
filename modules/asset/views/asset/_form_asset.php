  ...
  <div class="modal-dialog" role="document" style="width: 70%">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <h4>
    <b class="glyphicon glyphicon-user"></b> ผู้เบิกพัสดุ - ครุภัณฑ์
</h4>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group form-group-sm">
    				<label class="control-label col-sm-3" for="purchaseorder-name"> ผู้ขอเบิก</label>
                    <div class="col-sm-9">
...
<hr />
<h4>
    <b class="glyphicon glyphicon-shopping-cart"></b> สินทรัพย์ที่ขอเบิก
</h4>
    ...
    <table class="table table-striped table-bordered" style="margin-top: 15px">
      ...
      <div class="modal-footer">
        ...
        <div class="pull-right">
            <button type="button" ng-click="saveCart()" class="btn btn-primary">ขออนุมัติใบเบิก</button>
        </div>
