...
$this->title = Yii::t('app', 'ตรวจสอบใบเบิก');
    ...
    <div class="pull-right" style="margin-bottom: 2px">
        ...
        <div class="btn-group" role="group">
            <a class="btn btn-default btn-sm"
                href="index.php?r=asset/asset/grid-asset&AssetOrderSearch%5Bcreate_id%5D=<?=Yii::$app->user->id?>"
                >รายการของฉัน <span class="badge"><?php echo $countMyDoc; ?></span>
            </a>
             <a class="btn btn-default btn-sm"
               href="index.php?r=asset/asset/grid-asset"> รายการทั้งหมด <span class="badge"><?php echo $countAllDoc; ?></span></a>


            <a class="btn btn-default btn-sm"
               href="index.php?r=asset/asset/grid-asset&AssetOrderSearch%5Bstate%5D=wait">
                รออนุมัติ <span class="badge"><?php echo $countWait; ?></span></a>

            <a class="btn btn-default btn-sm"
               href="index.php?r=asset/asset/grid-asset&AssetOrderSearch%5Bstate%5D=approved">
                อนุมัติ <span class="badge"><?php echo $countApprover;?></span></a>
            
            <a class="btn btn-default btn-sm"
               href="index.php?r=asset/asset/grid-asset&AssetOrderSearch%5Bstate%5D=cancel">
            ...
            'columns' => [
                ...
                [
                    ...
                    'value'=> function ($model) {
                        return Html::a($model->name, Url::to(['/asset/asset/view-asset', 'id' => $model->id]), 
                        ['data-pjax' => 0]);
                    }
                ],
                ...
                [
                    ...
                    'value' => function ($model) {
                        ...
                        if($model->state == AssetOrder::WAIT) {
                            return  "<span class='label label-primary'> รออนุมัติ </span>";
                        } else if($model->state == AssetOrder::APPROVED) {
                            return "<span class='label label-success'> อนุมัติ </span>";
                        } else if($model->state == AssetOrder::CANCEL) {
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            $url = "index.php?r=asset/asset/view-asset&id=$model->id";
                        ...
                        'delete' => function ($url, $model, $key) {
                            $url = "index.php?r=asset/asset/delete-asset&id=$model->id";
                                if(in_array($model->state, [AssetOrder::WAIT, AssetOrder::CANCEL])) {
