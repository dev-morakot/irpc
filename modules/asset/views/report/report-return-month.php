...
$this->title = Yii::t('app', 'คืนครุภัณฑ์แจกตามประจำเดือน');
...
?>
<div class="report-return-month" ng-app="ReportApp" ng-controller="ReportReturnMonthController" ng-cloak>
        ...
        <table class="table table-striped table-bordered" style="margin-top: 15px">
            <thead>
                <tr>
                    ...
                    <th width="auto" style="text-align: center">ชื่อผู้ขอคืน</th>
            ...
            <tbody>
                <tr ng-repeat="line in report_return_month">
                    <td>{{ line.doc_name }}</td>
            ...
            <tfoot>
                <tr>
                    <th colspan="8">รวม</th>
                    <th style="text-align: right">{{ report_return_month | sumOfValue:'qty'}}</th>
                    <th></th>
                </tr>
            </tfoot>
        </table>
