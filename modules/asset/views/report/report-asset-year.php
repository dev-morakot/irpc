...
$this->title = Yii::t('app', 'เบิกจ่ายแยกประจำปี');
...
?>
<div class="report-asset-year" ng-app="ReportApp" ng-controller="ReportAssetYearController" ng-cloak>
        ...
        <table class="table table-bordered table-striped" style="margin-top: 15px">
            <thead>
                <tr>
                    ...
                    <th width="100px" style="text-align: center">จำนวนที่เบิกทั้งหมด</th>
                    <th width="100px" style="text-align: center"></th>
                </tr>
            </thead>
            <tbody>
                <tr ng-repeat="line in report_asset_year">
      ...
      <div class="modal-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="margin-top: 15px">
                    <thead>
                        <tr>
                            <th colspan="8" style="text-align: center">รายละเอียดการเบิกพัสดุ - ครุภัณฑ์ : {{ modline.date_approve | date: "MMMM" }}</th>
                        </tr>
                        <tr>
