...
$this->title = Yii::t('app', 'สรุปครุภัณฑ์ทั้งหมด');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="report-all">
    <h2><?= Html::encode("เบิกจ่ายแล้ว") ?></h2>
            ...
            'columns' => [
                ...
                [
                   ...
                   // 'format' => ['decimal',3],
                    ...
                    'footer' => AssetOrder::getTotal($dataProvider->models, 'qty')
                ],
    ...
    <h2><?= Html::encode("ยังไม่ได้เบิกจ่าย") ?></h2>
    <?php $states = ArrayHelper::map(Asset::asState(), 'id', 'name'); ?>
            ...
            'columns' => [
                ...
                [
                   ...
                   // 'format' => ['decimal',3],
                    ...
                    'footer' => AssetOrder::getTotal($gridData->models, 'qty')
                ],
                'unit_name:text:หน่วย',
                [
