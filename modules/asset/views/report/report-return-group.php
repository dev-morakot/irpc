...
?>
<div class="report-index" ng-app="ReportApp" ng-controller="ReportReturnGroupController" ng-cloak>
        ...
        <table class="table table-striped table-bordered" style="margin-top: 15px">
            <thead>
                <tr>
                    ...
                    <th width="auto" style="text-align: center">ชื่อผู้คืน</th>
            ...
            <tbody>
                <tr ng-repeat="line in report_return_group">
                    <td>{{ line.name }}</td>
