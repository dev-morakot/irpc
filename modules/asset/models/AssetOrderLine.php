...
/**
 * This is the model class for table "asset_order_line".
 *
 * @property integer $id
 ...
 */
class AssetOrderLine extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return AssetOrderLineQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new AssetOrderLineQuery(get_called_class());
    }
}
