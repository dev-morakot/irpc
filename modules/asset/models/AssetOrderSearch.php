...
use yii\db\Query;
/**
 * AssetOrderSearch represents the model behind the search form about `app\models\Asset`.
 */
class AssetOrderSearch extends AssetOrder
{
    /**
     * @inheritdoc
     */
    ...
    public function searchLine($params)
    {
        $query = (new Query())
        	...
        	')
        	->from('asset_order a')
        	->leftJoin('asset_order_line b','b.order_id = a.id')
